    ...
    public class InvoiceAppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PaymentTerm>().HasData(
                       new PaymentTerm() { PaymentTermId = 1, Description = "Net due 10 days", DueDays = 10 },
                new PaymentTerm() { PaymentTermId = 2, Description = "Net due 20 days", DueDays = 20 },
                new PaymentTerm() { PaymentTermId = 3, Description = "Net due 30 days", DueDays = 30 },
                new PaymentTerm() { PaymentTermId = 4, Description = "Net due 60 days", DueDays = 60 },
                new PaymentTerm() { PaymentTermId = 5, Description = "Net due 90 days", DueDays = 90 }
